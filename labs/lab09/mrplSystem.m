...
function sails = findSails(obj, maxNumOfSails)
    ...
    while toc(sail_scan_timer) < 3 && found_sail<maxNumOfSails
      if firstIter
          tic();
          firstIter = false;
      end
      ...
      % CUT OFF AT MAX DISTANCE IS HARDCODED
      goodones = r_values>min_r & r_values<1.8;
    ...
    %                 drawnow;
      ...
      pause(0.05)
    end % end of while loop (for running lidar)
