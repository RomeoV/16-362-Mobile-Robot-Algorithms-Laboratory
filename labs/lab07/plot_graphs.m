...
subplot(1,3,2)
plot(log_data.theta_est_data); hold on;
plot(log_data.theta_data); hold off;

subplot(1,3,3)
plot(log_data.error_x_data); hold on;
plot(log_data.error_y_data);
plot(log_data.error_theta_data); hold off;
